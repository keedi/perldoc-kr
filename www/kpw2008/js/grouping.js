...
Ext.grid.dummyData = [
    ...
    [
      ...
      '19:35 ~ 19:40',
      '2. 짧은 발표 (Lightening Talk)',
      '대 표적인 네트워크 시뮬레이션툴 NS2의 출력파일인 트레이스 파일은 칼럼으로 구분되어 각종 정보가 기록되어 있다. perl을 이용하여 이 파일에서 throughput, delay 등 유용한 정보를 추출(extraction)하고 그래프를 얻기 위해 결과물을 정리(report)하는 방법에 대해서 알아본다.'
    ],
    [
